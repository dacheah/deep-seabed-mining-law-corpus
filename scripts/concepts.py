...
KW = {
    "the_area_and_common_heritage": ["common heritage", "the area and its resources", "vested in mankind",
        "appropriate any part", "sovereignty or sovereign rights over", "benefit of mankind", "patrimoine commun de l", "la zone et ses ressources", "ressources de la zone", "au nom de l’humanité", "dans l’intérêt de l’humanité", "patrimonio común de la humanidad", "la zona y sus recursos", "en nombre de la humanidad", "recursos de la zona"],
    "definitions_and_scope": ["use of terms", "for the purposes of this", "\"resources\"", "\"minerals\"",
        "scope of this part", "means all solid", "aux fins du présent", "on entend par", "termes utilisés dans la convention", "a los efectos del presente", "se entiende por", "términos empleados"],
    "sponsoring_state_responsibility_and_liability": ["responsibility to ensure", "liability for damage",
        "sponsored", "sponsoring", "joint and several liability", "shall have the responsibility", "liable", "état qui patronne", "états qui patronnent", "état patronnant", "qui patronnent des", "responsabilité", "obligation de diligence", "diligence requise", "obligations de l’état", "estado patrocinante", "estados patrocinantes", "estado que patrocina", "responsabilidad", "diligencia debida", "obligaciones del estado"],
    "isa_institutional_structure": ["the assembly", "the council", "legal and technical commission",
        ...
        "economic planning commission", "organs of the authority", "autorité internationale des fonds marins", "l’autorité", "le conseil", "l’assemblée", "commission juridique et technique", "secrétaire général", "l’entreprise", "organes de l’autorité", "autoridad internacional de los fondos marinos", "la autoridad", "el consejo", "la asamblea", "comisión jurídica y técnica", "secretario general", "la empresa", "órganos de la autoridad"],
    "exploration_and_exploitation_system": ["plan of work", "plans of work", "system of exploration and exploitation",
        "qualifications of applicants", "security of tenure", "contract", "prospecting, exploration", "plan de travail", "contrat d’exploration", "exploration et d’exploitation", "prospection", "contractant", "plan de trabajo", "contrato de exploración", "exploración y explotación", "prospección", "contratista"],
    "reserved_areas_and_the_enterprise": ["reserved area", "the enterprise", "joint arrangement", "parallel", "secteur réservé", "coentreprise", "área reservada", "empresa conjunta"],
    "benefit_sharing_and_financial_regime": ["equitable sharing", "financial and other economic benefits",
        "payments and contributions", "financial terms", "funds of the authority", "royalt", "fee", "avantages financiers", "partage des avantages", "redevance", "beneficios financieros", "distribución de beneficios", "regalía", "canon"],
    "production_policy_and_economic_effects": ["production authorization", "production ceiling", "production polic",
        "commodity", "nickel", "adverse effects", "export earnings", "economic adjustment", "politique de production", "autorisation de production", "política de producción", "autorización de producción"],
    "marine_environmental_protection": ["protection of the marine environment", "protection for the marine environment",
        "precautionary", "harmful effects", "pollution", "ecological balance", "flora and fauna", "best environmental", "protection du milieu marin", "milieu marin", "approche de précaution", "principe de précaution", "préservation du milieu marin", "effets nocifs", "protección del medio marino", "medio marino", "criterio de precaución", "mejores prácticas ambientales", "efectos nocivos"],
    "environmental_assessment_and_monitoring": ["environmental impact", "assessment", "monitoring programme",
        "monitor", "environmental management", "environmental implications", "évaluation de l’impact", "étude d’impact sur l’environnement", "evaluación del impacto ambiental", "vigilancia ambiental"],
    "marine_scientific_research": ["marine scientific research", "scientific research in the area", "recherche scientifique marine", "investigación científica marina"],
    "technology_transfer_and_capacity": ["transfer of technology", "transfer to developing", "training",
        "scientific knowledge", "capacity", "transfert des techniques", "transfert de technologie", "formation du personnel", "transmisión de tecnología", "transferencia de tecnología", "capacitación"],
    "developing_states_special_interests": ["developing states", "developing countries", "land-locked",
        "geographically disadvantaged", "special interests", "special need", "états en développement", "pays en développement", "sans littoral", "géographiquement désavantagés", "estados en desarrollo", "países en desarrollo", "sin litoral", "geográficamente desfavorecidos"],
    "peaceful_use_and_general_conduct": ["peaceful purposes", "general conduct of states", "fins pacifiques", "exclusivement pacifiques", "fines pacíficos", "exclusivamente con fines pacíficos"],
    "protection_of_human_life_and_safety": ["protection of human life", "safety zones", "safety of both navigation",
        "installations", "protection de la vie humaine", "sécurité de la navigation", "protección de la vida humana", "seguridad de la navegación"],
    "compliance_inspection_and_enforcement": ["inspect", "emergency order", "suspension or adjustment",
        "penalt", "non-compliance", "compliance", "sanction", "veiller au respect", "assurer le respect", "mesures nécessaires pour assurer", "velar por el cumplimiento", "asegurar el cumplimiento", "medidas necesarias para asegurar"],
    "dispute_settlement_and_advisory_opinions": ["seabed disputes chamber", "settlement of disputes", "dispute",
        "advisory opinion", "jurisdiction", "arbitration", "chambre pour le règlement des différends", "avis consultatif", "règlement des différends", "différend", "sala de controversias de los fondos marinos", "opinión consultiva", "solución de controversias", "controversia"],
    "privileges_immunities_and_legal_status": ["privileges and immunities", "immunity", "legal personality",
        "legal status", "inviolable", "exempt from", "privilèges et immunités", "personnalité juridique", "privilegios e inmunidades", "personalidad jurídica"],
    "review_and_amendment": ["periodic review", "review conference", "amendment", "shall undertake a general", "conférence de révision", "réexamen", "amendement", "conferencia de revisión", "enmienda"],
